...
initial_dvs['twist'] = np.array([-0.02670733,  0.00396999,  0.00206548,  0.02087249,  0.02193591, 0.03856382, -0.02119188])*100.0
initial_dvs['sweep'] = np.array([ 0.09994278])*10.0
initial_dvs['area'] = np.array([ 0.10856287])*10.0
